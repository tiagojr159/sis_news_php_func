...
<div class='trand-right-cap'>
							<?php
								$id_jornalista = $_GET['jornalista'];
								$consulta = mysqli_query($con->connect(),"select n.*,
								(SELECT nome_arquivo arquivo FROM imagem i where i.id_noticia = n.id and i.tipo = 'N'  and exibir = 'S' 
								 order by id desc limit 1) as arquivo,
								 (select j.nome from jornalista j where j.id = n.autor) as nome
								 from noticia n where n.autor = ".$id_jornalista."
