...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Exibir _MENU_ Registros",sZeroRecords:"Registro Não encontrado",sEmptyTable:"No data available in table",
sLoadingRecords:"Buscando...",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 de 0 a 0 registros",sInfoFiltered:"(Filtrado from _MAX_ total registros)",sInfoPostFix:"",sSearch:"Pesquisar:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
